...
public class Orderfoods {
	...
	public Orderfoods(int item_id, int quantity, double total_price) {
		super();
		this.item_id = item_id;
		this.quantity = quantity;
		this.total_price = total_price;
	...
	@Override
	public int hashCode() {
		return Objects.hash(item_id, quantity, total_price);
	}
	@Override
	...
	public String toString() {
		return "Orderfoods [item_id=" + item_id + ", quantity=" + quantity + ", total_price=" + total_price + "]";
	}
